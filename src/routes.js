...
const routes = [
  ...
  { path: '/thesisProposal', name: 'thesisProposal', element: ThesisProposal, roles: ['Student'] },
  {
  ...
  { path: '/groupDetails', name: 'groupDetails', element: GroupDetails, roles: ['Student'] },
  ...
  { path: '/myStudents', name: 'myStudents', element: MyStudents, roles: ['Teacher'] },
